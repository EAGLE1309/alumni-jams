    ...
    <section className="h-full relative p-4 pt-8 lg:px-8 flex flex-col lg:flex-row bg-zinc-100 dark:bg-[#0D0D0D] items-start gap-5 w-full">
      <div className="w-full flex flex-col items-start justify-center max-w-2xl">
        ...
        <p className="text-center text-xlg text-zinc-600 dark:text-zinc-400 mb-8">
          Your contributions help fund training programs, competitions, and
          student clubs.
        </p>

        <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8">
          <b className="text-green-600 pr-1">Support Students:</b> Provide
          scholarships and resources for those in need.
        </p>
        <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8">
          <b className="text-green-600 pr-1">Foster Innovation:</b> Fund clubs,
          research, and entrepreneurial projects.
        </p>
        <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8">
          <b className="text-green-600 pr-1">Enhance Campus Life:</b> Improve
          facilities and support vibrant extracurricular programs.
        </p>
        ...
        <Link
          ...
          href="https://payments-test.cashfree.com/forms/alumni-jams"
        >
          Donate Now
        </Link>
      </div>
